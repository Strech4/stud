...
const useCurrentPath = (links: any[]) => {
                        ...
                        {section.links.map((link) => {
                            ...
                            return (
                                <Link
                                    key={link.url}
                                    className={cn(
                                        "flex h-8 items-center gap-2 rounded-md px-2 transition-colors text-sm font-medium ",
                                        "hover:bg-card",
                                        {
                                            "bg-accent/50 hover:bg-accent/80 text-muted-foreground": isCurrent,
                                        },
                                    )}
                                    href={link.url}
                                >
